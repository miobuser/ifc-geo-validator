"""
Create test model T9 (v2): Stepped retaining wall as 2 separate IFC elements.

Specifications:
- 2 separate IfcWall elements (PredefinedType=RETAININGWALL):
  1. Upper wall ("Oberer Steg T9"): 8.0m x 0.3m x 1.5m at z=1.5..3.0
  2. Lower foundation course ("Unterer Sockel T9"): 8.0m x 0.6m x 1.5m at z=0..1.5
- Each wall has its own IfcFacetedBrep (6 quad faces per box)
- Both walls contained in one IfcFacility
- IFC4X3_ADD2 schema
...
def main():
    ...
    project.Description = "T9 — Abgestufte Stützmauer als 2 separate Elemente (oberer Steg + unterer Sockel)"
